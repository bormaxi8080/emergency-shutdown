...
> Разработка данного ПО еще не полностью закончена, поэтому для скриптов, в названии которых есть постфикс "beta" рекомендуется сначала производить их запуск на тестовой виртуальной машине.

Запуск скриптов из этого репозитария может привести к необратимой потере ваших данных.
Поэтому перед настройкой, тестированием и запуском этого ПО обязательно убедитесь, что вы корректно настроили резервное копирование ваших данных!
...
## РЕКОМЕНАЦИИ ДЛЯ РАЗНЫХ ТИПОВ ОПЕРАЦИОННЫХ СИСТЕМ:
